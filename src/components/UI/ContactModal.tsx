  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.mainOption === 'buy') {
        message = 'Purchase request submitted successfully! We will contact you soon to finalize your purchase.';
      } else {
        message = `${formData.rentPeriod.charAt(0).toUpperCase() + formData.rentPeriod.slice(1)} rental request submitted successfully! We will contact you soon to arrange your rental.`;
      }
